...
public class PopMenuLayout extends RelativeLayout {
    ...
    private int mVertical = UP;


    private Paint mPaint;
    public static final int SHARP_WIDTH = 35;
    public static final int SHARP_HEIGHT = (int) (SHARP_WIDTH * 1.0f);
    private static final int RECT_CORNER = 15;
...
//        setPaddingRelative(0, 0, 0, SHARP_HEIGHT);
//        setMinimumHeight(SHARP_HEIGHT * 3);
//        setMinimumWidth(mXoffset * 2 + SHARP_HEIGHT);
    ...
    private Path makeSharpPath() {
        mSharpPath.moveTo(mXoffset + SHARP_HEIGHT / 2, getMeasuredHeight());
        mSharpPath.lineTo(mXoffset, getMeasuredHeight() - SHARP_HEIGHT);
        mSharpPath.lineTo(mXoffset + SHARP_HEIGHT, getMeasuredHeight() - SHARP_HEIGHT);
//

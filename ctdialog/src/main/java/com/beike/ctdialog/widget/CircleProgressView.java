...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //当前进度
        progress = typedArray.getInt(R.styleable.CircleLoadingView_progress, 0);
        //回收资源
        typedArray.recycle();

//        viewWidth = context.getResources().getDisplayMetrics().widthPixels/4;
    }
...
//        viewWidth = viewWidth < realWidth ? realWidth : viewWidth;
